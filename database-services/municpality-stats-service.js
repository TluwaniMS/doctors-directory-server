...
async function getMunicipalityWithHospitalsAndNestedDoctorGendersByKey(
	municipalKey
) {
	const municipalityWithHospitalsAndNestedDoctorGenders =
		await Municipality.findAll({
...
async function getMunicipalityWithHospitalsAndNestedDoctorSpecialtiesByKey(
	municipalKey
) {
	const municipalityWithHospitalsAndNestedDoctorSpecialties =
		await Municipality.findAll({
			where: { municipalityKey: municipalKey },
			attributes: ['municipalityName'],
			include: [
...
async function getMunicipalityWithHospitalsAndNestedDoctorSpecialtiesAndGenderByKey(
	municipalKey
) {
	const municipalityWithHospitalsAndNestedDoctorSpecialtiesAndGender =
		await Municipality.findAll({
			where: { municipalityKey: municipalKey },
			attributes: ['municipalityName'],
			include: [
...
async function getMunicipalityWithHospitalsAndNestedDoctorsByKey(municipalKey) {
	const municipalityWithHospitalsAndNestedDoctors =
		await Municipality.findAll({
			where: { municipalityKey: municipalKey },
			attributes: ['municipalityName'],
			include: [
